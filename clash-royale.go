...
var (
	KNIGHT = Card{
		...
		COST:   3,
		HP:     []int{600, 660, 726, 798, 876, 960, 1056, 1158, 1272, 1398, X, 1686},
		DPS:    []int{68, 74, 81, 90, 99, 109, 120, 130, 144, 158, X, 190},
		DAM:    []int{75, 82, 90, 99, 109, 120, 132, 144, 159, 174, X, 210},
		HSPD:   1.1,
		TGTS:   GROUND,
		SPD:    MEDIUM,
		RNG:    MELEE,
	...
	SKELETONS = Card{
		...
		COST:   1,
		HP:     []int{30, 33, 36, 39, 43, 48, 52, 57, X, 69, 76, X},
		DPS:    []int{30, 33, 36, 39, 43, 48, 52, 57, X, 69, 76, X},
		DAM:    []int{30, 33, 36, 39, 43, 48, 52, 57, X, 69, 76, X},
		HSPD:   1,
		TGTS:   GROUND,
		SPD:    FAST,
		RNG:    MELEE,
	...
	MINIONS = Card{
		...
		COST:   3,
		HP:     []int{90, 99, 108, 119, 131, 144, 158, X, 190, 209, 230, 252},
		DPS:    []int{40, 44, 48, 53, 58, 64, 70, X, 84, 93, 102, 112},
	...
	GIANT = Card{
		...
		COST:   5,
		HP:     []int{2000, 2200, 2420, 2660, 2920, X, X, 3860, X, 4660},
		DPS:    []int{80, 88, 96, 106, 116, X, X, 154, X, 186},
		DAM:    []int{120, 132, 145, 159, 175, X, X, 231, X, 279},
		HSPD:   1.5,
		TGTS:   BUILDINGS,
		SPD:    SLOW,
		RNG:    MELEE,
	...
	MUSKETEER = Card{
		...
		DAM:    []int{100, X, 121, 133, 146, X, X, 193, 212, 233},
		HSPD:   1.1,
		TGTS:   AIR_AND_GROUND,
		SPD:    MEDIUM,
		RNG:    6.5,
